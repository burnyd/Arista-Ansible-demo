...
#Configure a forwarded port to access eAPI on vEOS
 #https://username:password@localhost:8443/command-api
   leaf1a.vm.network "forwarded_port", guest: 443, host: 5443
    end
...
#Configure a forwarded port to access eAPI on vEOS
 ...
 #https://username:password@localhost:8446/command-api
  ...
  config.vm.define "mgt1" do |mgt1|
    ...
    mgt1.vm.network "forwarded_port", guest: 443, host: 6443
    mgt1.vm.network "forwarded_port", guest: 80, host: 6480
    mgt1.vm.network "forwarded_port", guest: 8080, host: 6488
    mgt1.vm.network "forwarded_port", guest: 5601, host: 6456
